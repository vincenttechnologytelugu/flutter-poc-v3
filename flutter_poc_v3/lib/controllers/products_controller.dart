 ...
 getData() async {
  try {
    ...
    update();
     ...
     http.Response response = await http.get(Uri.parse("http://192.168.0.170:8080/adposts"));
  ...
  //       .get(Uri.parse("http://192.168.0.170:8080/categories/$categories"));
...
Future<void> getAllCategories() async {
    try {
      final response = await http.get(
        Uri.parse("http://192.168.0.170:8080/categories")
      );
