...
class _CategoryDetailsScreenState extends State<CategoryDetailsScreen>
  ...
  final List<Map<String, dynamic>> carBrands = [
    ...
    {'name': 'Volkswagen', 'icon': Icons.directions_car, 'findkey': 'volkswagen'},
    {'name': 'BMW', 'icon': Icons.directions_car, 'findkey': 'bmw'},
    {'name': 'Mercedes', 'icon': Icons.directions_car, 'findkey': 'mercedes'},
    {'name': 'Audi', 'icon': Icons.directions_car, 'findkey': 'audi'},
    {'name': 'Skoda', 'icon': Icons.directions_car, 'findkey': 'skoda'},
    {'name': 'Ferrari', 'icon': Icons.directions_car, 'findkey': 'ferrari'},
    {'name': 'Lamborghini', 'icon': Icons.directions_car, 'findkey': 'lamborghini'},
    {'name': 'Porsche', 'icon': Icons.directions_car, 'findkey': 'porsche'},
    {'name': 'Maserati', 'icon': Icons.directions_car, 'findkey': 'maserati'},
    {'name': 'Jaguar', 'icon': Icons.directions_car, 'findkey': 'jaguar'},
    {'name': 'Land Rover', 'icon': Icons.directions_car, 'findkey': 'land_rover'},
    {'name': 'Mini', 'icon': Icons.directions_car, 'findkey': 'mini'},
    {'name': 'Volvo', 'icon': Icons.directions_car, 'findkey': 'volvo'},
    {'name': 'Aston Martin', 'icon': Icons.directions_car, 'findkey': 'aston_martin'},
    {'name': 'Bentley', 'icon': Icons.directions_car, 'findkey': 'bentley'},
    {'name': 'Bugatti', 'icon': Icons.directions_car, 'findkey': 'bugatti'},
    {'name': 'Fiat', 'icon': Icons.directions_car, 'findkey': 'fiat'},
    {'name': 'Force Motors', 'icon': Icons.directions_car, 'findkey': 'force_motors'},
    {'name': 'Isuzu', 'icon': Icons.directions_car, 'findkey': 'isuzu'},
    {'name': 'Kia', 'icon': Icons.directions_car, 'findkey': 'kia'},
    {'name': 'Lexus', 'icon': Icons.directions_car, 'findkey': 'lexus'},
    {'name': 'Mazda', 'icon': Icons.directions_car, 'findkey': 'mazda'},
    {'name': 'McLaren', 'icon': Icons.directions_car, 'findkey': 'mclaren'},
    {'name': 'Rolls-Royce', 'icon': Icons.directions_car, 'findkey': 'rolls_royce'},
