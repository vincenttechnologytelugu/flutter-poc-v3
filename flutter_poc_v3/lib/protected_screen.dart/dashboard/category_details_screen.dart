...
class _CategoryDetailsScreenState extends State<CategoryDetailsScreen>
  ...
  final Map<String, List<Map<String, dynamic>>> categorySubcategories = {
    ...
    'Pets': [
      {'title': 'Dogs', 'icon': Icons.pets, 'findkey': 'dogs'},
  ...
  void navigateToCategoryPosts(
    ...
    String baseUrl = 'http://172.21.208.1:8080/adposts';
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          backgroundColor: const Color.fromARGB(255, 108, 114, 181),
          bottom: TabBar(
  ...
  //         controller: _tabController,
  //         tabs: const [
  //           Tab(icon: Icon(Icons.currency_rupee), text: 'Budget & Brand'),
  ...
  //                   return InkWell(
  //                     onTap: () =>
  //                         navigateToCategoryPosts(findkey: brand['findkey']),
  //                     child: Column(
  //                       mainAxisAlignment: MainAxisAlignment.center,
  //                       children: [
  //                         Container(
  ...
  //                   return ElevatedButton(
  //                     onPressed: () =>
  //                         navigateToCategoryPosts(year: year['year']),
  //                     style: ElevatedButton.styleFrom(
  //                       shape: RoundedRectangleBorder(
  //                         borderRadius: BorderRadius.circular(8),
  //                       ),
